    ...
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-semibold mb-2">Yilong</h2>
          <p className="text-gray-600 dark:text-gray-400">Digital Creator & Developer</p>
        </div>

        <div className="space-y-6 text-gray-700 dark:text-gray-300">
          <p>
            Hi there! I'm Yilong, a passionate developer and digital creator. I love building things for the web and sharing my knowledge with others.
          </p>
          ...
          <div>
            ...
            <p>
              I'm always interested in connecting with fellow developers and tech enthusiasts. Feel free to reach out to me on social media or through email.
            </p>
